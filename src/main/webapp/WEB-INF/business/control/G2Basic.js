...
var CR_G2Basic	=	{
	...
	,	begin	:
			function(){
				...
				this.grid = new G2($hD("#G2BasicList"),{InitialSearch:false});
				this.buttonset();
				this.formload();
			}
	...
	,	buttonset	:
			function(){
				$U.each($hA("span"),function(o){
					...
					case "insert" : 
						$U.eventbind(o, "onclick" , function(){ CR_G2Basic.popupregist(); });
						break;
					}
				});
			}
				...
				this.popwin = new $P({	target		:	ooo
						...
						,	afterOpen	:	function(poo){
								...
								try{
									...
									alert("[ CR_G2Basic > regist popup call ]" + e);
								} finally {
								}	
