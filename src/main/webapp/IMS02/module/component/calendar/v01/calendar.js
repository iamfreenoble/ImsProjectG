...
calendar = {
	...
	set: function(input_o, opt) {
		...
		var ths = this;
		ths.opt['input'] = $U.get(input_o,"id");
		ths.showCalendar();
		
		$U.eventbind(input_o,"onclick", _calendar_active_instance.optionhideCalendar );
		$U.eventbind(input_o,"onkeyup", _calendar_active_instance.optionhideCalendar2 );
